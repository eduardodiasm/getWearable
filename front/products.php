			...
			<div class="row justify-content-center">
				<div class="col-md-10 mb-5 text-center">
					<ul class="product-category">
						<li><a href="./admin/add-product.php" class="active">Adicionar Produto</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
						...
						<div class="text py-4 pb-4 px-4 text-center">
							...
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex">
									...
									<a href="./product-single.php?id=<?php echo $product['id']; ?>" class="heart d-flex justify-content-center align-items-center ">
