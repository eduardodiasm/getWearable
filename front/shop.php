...
<body class="goto-here">
	...
	<div class="hero-wrap hero-bread"
		style="background-image: url('https://atriumhealth.org/dailydose/-/media/daily-dose-blog/featured-images/hw-fitness-tracker_featured.jpg?h=1080&la=en&w=1920&hash=054879BF8652A5A951D02ABC5BAF92B2C84AA142');">
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Início</a></span> <span>Loja</span></p>
						...
						<div class="text py-4 pb-4 px-4 text-center">
							...
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex">
									...
									<a href="../back/cart/controller/add_product_in_cart.php?adicionar=<?php echo $product['id'];?>" class="buy-now d-flex justify-content-center align-items-center mx-1">
