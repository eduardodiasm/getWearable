      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Página inicial</a></span> <span class="mr-2"><a href="index.php">Produto</a></span></p>
    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
	          	...
	          	<div class="w-100"></div>
	          	<div class="col-md-12">
	          		<p style="color: #000;">Quantidade disponível: <?php echo $produto['quantity']; ?></p>
	          	</div>
          	</div>
          	<p><a href="cart.php" class="btn btn-black py-3 px-5">Adicionar ao carrinho</a></p>
    			</div>
    		</div>
    	</div>
    </section>
