      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">Atualizar produto</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form action="../../back/admin/products/update.php" method="POST" enctype="multipart/form-data" class="billing-form">
              <input type="hidden" name="id" value="<?php echo $id; ?>">
	          	...
	          	<div class="row align-items-end">
	                ...
	                <div class="form-group">
	                  ...
	                  <input type="text" value="<?php echo $product['name']; ?>" name="name" class="form-control" placeholder="">
	                </div>
	              </div>
                <div class="w-100"></div>
		            <div class="col-md-12">
                    ...
                    <textarea class="form-control" value="<?php echo $product['description']; ?>" name="description" rows="3"></textarea>
		            	</div>
		            </div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
	                  ...
	                  <input type="number" value="<?php echo $product['price']; ?>" name="price" class="form-control" placeholder="">
	                </div>
		            </div>
		            <div class="col-md-6">
		            	<div class="form-group">
		            		<label for="quantity">Quantidade</label>
	                  <input type="number" value="<?php echo $product['quantity']; ?>" name="quantity" class="form-control" placeholder="">
	                </div>
		            </div>
                <!-- <div class="w-100"></div> -->
                <div class="col-md-12">
                    ...
                    <input type="file" class="form-control-file" value="../../back/image/produtcs/<?php echo $product['principal_photo']; ?>" id="image" id="principal_photo" name="principal_photo">
	                </div>
		            </div>
                <div class="w-100"></div>
                <br>
              ...
              <div class="col-md-12">
								<div class="form-group">
									<button class="col-md-12 btn btn-primary py-3 px-4" type="submit">Atualizar</button>
								</div>
	          	</div>
	          </div>
          </div>
